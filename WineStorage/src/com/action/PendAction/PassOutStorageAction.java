 ...
 */
public class PassOutStorageAction extends ActionSupport implements RequestAware, SessionAware, ApplicationAware {
    ...
    public String execute() throws Exception {
        ...
        if(pendOutStorageService.passOutStorage(outStorageId, (String)session.get("userId"))){
            return SUCCESS;
        }else{
            return ERROR;
        }
