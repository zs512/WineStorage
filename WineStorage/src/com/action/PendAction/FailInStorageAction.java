 ...
 */
public class FailInStorageAction extends ActionSupport implements RequestAware, SessionAware, ApplicationAware {
    ...
    public String execute() throws Exception {
        ...
        if(pendInStorageService.failInStorage(inStorageId, (String)session.get("userId"))){
            return SUCCESS;
        }else{
            return ERROR;
        }
