...
/**
 	* A data access object (DAO) providing persistence and search support for ComItem entities.
 			* Transaction control of the save(), update() and delete() operations 
		can directly support Spring container-managed transactions or they can be augmented	to handle user-managed Spring transactions. 
		Each of these methods provides additional information for how to configure it for the desired type of transaction control. 	
	 * @see com.domain.ComItem
...
public class ComItemDAO  {
	...
	public static final String SOTRAGE = "sotrage";
    ...
    public ComItem findById( java.lang.String id) {
        log.debug("getting ComItem instance with id: " + id);
        try {
            ComItem instance = (ComItem) getCurrentSession()
                    .get("com.domain.ComItem", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List<ComItem> findByExample(ComItem instance) {
        ...
        try {
            List<ComItem> results = (List<ComItem>) getCurrentSession() .createCriteria("com.domain.ComItem").add( create(instance) ).list();
	...
	public List<ComItem> findBySotrage(Object sotrage
	) {
		return findByProperty(SOTRAGE, sotrage
		);
	}
    ...
    public ComItem merge(ComItem detachedInstance) {
        ...
        try {
            ComItem result = (ComItem) getCurrentSession()
