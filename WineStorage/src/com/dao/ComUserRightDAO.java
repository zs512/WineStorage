...
/**
 	* A data access object (DAO) providing persistence and search support for ComUserRight entities.
 			* Transaction control of the save(), update() and delete() operations 
		can directly support Spring container-managed transactions or they can be augmented	to handle user-managed Spring transactions. 
		Each of these methods provides additional information for how to configure it for the desired type of transaction control. 	
	 * @see com.domain.ComUserRight
  * @author MyEclipse Persistence Tools 
 */
    @Transactional   
public class ComUserRightDAO  {
	     private static final Logger log = LoggerFactory.getLogger(ComUserRightDAO.class);
		//property constants
    ...
    public ComUserRight findById( java.lang.String id) {
        log.debug("getting ComUserRight instance with id: " + id);
        try {
            ComUserRight instance = (ComUserRight) getCurrentSession()
                    .get("com.domain.ComUserRight", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List<ComUserRight> findByExample(ComUserRight instance) {
        ...
        try {
            List<ComUserRight> results = (List<ComUserRight>) getCurrentSession() .createCriteria("com.domain.ComUserRight").add( create(instance) ).list();
    ...
    public List findByProperty(String propertyName, Object value) {
      log.debug("finding ComUserRight instance with property: " + propertyName
            + ", value: " + value);
      try {
    ...
    public ComUserRight merge(ComUserRight detachedInstance) {
        ...
        try {
            ComUserRight result = (ComUserRight) getCurrentSession()
	...
	public static ComUserRightDAO getFromApplicationContext(ApplicationContext ctx) {
