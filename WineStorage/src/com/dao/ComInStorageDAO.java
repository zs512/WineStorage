...
/**
 	* A data access object (DAO) providing persistence and search support for ComInStorage entities.
 			* Transaction control of the save(), update() and delete() operations 
		can directly support Spring container-managed transactions or they can be augmented	to handle user-managed Spring transactions. 
		Each of these methods provides additional information for how to configure it for the desired type of transaction control. 	
	 * @see com.domain.ComInStorage
  * @author MyEclipse Persistence Tools 
 */
    @Transactional   
public class ComInStorageDAO  {
	     private static final Logger log = LoggerFactory.getLogger(ComInStorageDAO.class);
		//property constants
    ...
    public ComInStorage findById( java.lang.String id) {
        log.debug("getting ComInStorage instance with id: " + id);
        try {
            ComInStorage instance = (ComInStorage) getCurrentSession()
                    .get("com.domain.ComInStorage", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List<ComInStorage> findByExample(ComInStorage instance) {
        ...
        try {
            List<ComInStorage> results = (List<ComInStorage>) getCurrentSession() .createCriteria("com.domain.ComInStorage").add( create(instance) ).list();
    ...
    public List findByProperty(String propertyName, Object value) {
      log.debug("finding ComInStorage instance with property: " + propertyName
            + ", value: " + value);
      try {
    ...
    public ComInStorage merge(ComInStorage detachedInstance) {
        ...
        try {
            ComInStorage result = (ComInStorage) getCurrentSession()
	...
	public static ComInStorageDAO getFromApplicationContext(ApplicationContext ctx) {
